...
public class QuartzTest extends AbstractTest {
    ...
    public void testBasicStorageFunctions() throws Exception {
        ...
        assertTrue("State of trigger t2 expected to be PAUSED ", s.equals(Trigger.TriggerState.PAUSED));
        ...
        assertTrue("State of trigger t4 expected to be PAUSED ", s.equals(Trigger.TriggerState.PAUSED));
